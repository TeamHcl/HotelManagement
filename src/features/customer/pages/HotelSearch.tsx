...
const MOCK_HOTELS = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 89,
    image: 'https://images.unsplash.com/photo-1501117716987-c8c394bb29df?auto=format&fit=crop&q=80&w=800',
      ...
      <div className="relative pt-40 pb-32 flex items-center justify-center min-h-[75vh] overflow-hidden rounded-b-[40px] shadow-2xl mx-2 md:mx-4 mt-2">
        ...
        <div className="container relative z-10 px-4 md:px-0">
          <div className="max-w-4xl space-y-8 mx-auto text-center">
            ...
            <Badge variant="outline" className="border-primary/50 text-cyan-300 bg-primary/20 backdrop-blur-md px-5 py-2 rounded-full uppercase tracking-widest font-bold shadow-2xl hover:bg-primary/30 transition-colors cursor-pointer">
              Elevate Your Escape
            </Badge>
            ...
            <p className="text-lg md:text-2xl text-white/90 max-w-3xl mx-auto font-medium drop-shadow-xl mt-6">
              Seamlessly browse, select, and book premium stays across the globe with our secure centralized portal.
            </p>
              ...
              <CardContent className="p-0 flex flex-col md:flex-row gap-3 md:items-center">
                ...
                <div className="flex-1 flex items-center gap-4 bg-white/5 border border-white/10 hover:border-white/20 rounded-2xl px-5 py-4 min-h-[70px] transition-all group cursor-text">
                  ...
                  <div className="flex flex-col items-start justify-center flex-1">
                    <span className="text-[11px] uppercase font-extrabold text-muted-foreground tracking-widest mb-1.5 focus-within:text-white transition-colors">Destination</span>
                    <Input 
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <div className="flex-2 flex items-center gap-4 bg-white/5 border border-white/10 hover:border-white/20 rounded-2xl px-5 py-4 min-h-[70px] transition-all group cursor-pointer w-full md:w-[280px]">
                      ...
                      <div className="flex flex-col items-start justify-center flex-1 w-full truncate">
                        <span className="text-[11px] uppercase font-extrabold text-muted-foreground tracking-widest mb-1.5 transition-colors group-hover:text-white">Dates</span>
                        <div className={`text-lg font-semibold w-full truncate transition-colors ${dateRange ? 'text-white' : 'text-white/60 group-hover:text-white'}`}>
                          {dateRange?.from ? (
                            dateRange.to ? (
                              <>
                  ...
                  <PopoverContent className="w-auto p-3 border-white/20 glass rounded-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] bg-black/80 backdrop-blur-2xl" align="center">
                    <Calendar
                      initialFocus
                      mode="range"
                ...
                <div className="w-full md:w-[200px] flex items-center gap-4 bg-white/5 border border-white/10 hover:border-white/20 rounded-2xl px-5 py-4 min-h-[70px] transition-all group cursor-pointer">
                  ...
                  <div className="flex flex-col items-start justify-center flex-1 w-full text-left">
                    <span className="text-[11px] uppercase font-extrabold text-muted-foreground tracking-widest mb-1.5 transition-colors group-hover:text-white">Travelers</span>
      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto max-w-7xl mt-8">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-10 gap-6">
          <div className="flex-1">
            <Badge variant="outline" className="mb-4 text-cyan-400 border-cyan-400/30 bg-cyan-400/10 uppercase tracking-widest text-[11px] font-bold px-4 py-1.5 rounded-full">
              Curated For You
            </Badge>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white drop-shadow-md">Trending Stays</h2>
            <p className="text-muted-foreground mt-4 text-lg max-w-2xl leading-relaxed">
              Explore our hand-picked selection of top-rated destinations offering exclusive amenities and unparalled comfort.
            </p>
          </div>
          
          <Button asChild variant="outline" className="hidden sm:flex items-center gap-2 group hover:bg-white/10 border-white/20 glass text-foreground h-12 px-6 rounded-xl font-bold shadow-lg shrink-0">
            <Link to="/">
        ...
        <Button asChild variant="outline" className="w-full sm:hidden mt-10 h-14 rounded-xl border-white/20 glass font-bold text-lg flex items-center justify-center gap-2 shadow-lg">
          <Link to="/">
