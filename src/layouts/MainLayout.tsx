...
import { Menu, Search, LogIn, Diamond } from "lucide-react";
        ...
        <div className="container flex h-20 max-w-7xl mx-auto items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex-1">
            <Link to="/" className="inline-flex items-center gap-2.5 group">
              <Diamond className="h-7 w-7 text-cyan-400 group-hover:scale-105 transition-transform" strokeWidth={1.5} />
              <span className="text-2xl font-black tracking-tight bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">
                Luxe<span className="text-cyan-400 drop-shadow-[0_0_15px_rgba(34,211,238,0.5)]">Stay</span>
              </span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex flex-1 items-center justify-center gap-8 text-sm font-bold uppercase tracking-widest text-muted-foreground">
            <Link to="/" className="text-white hover:text-cyan-400 transition-colors drop-shadow-md">
              Find Stays
            </Link>
          ...
          <div className="flex flex-1 items-center justify-end gap-3 sm:gap-4">
            <div className="hidden md:flex items-center gap-3">
              <Button variant="ghost" className="text-muted-foreground hover:text-white font-semibold transition-colors" asChild>
                <Link to="/login">
                  <LogIn className="w-4 h-4 mr-2" />
                  Sign In
                </Link>
              </Button>
              <Button asChild className="rounded-full px-7 font-bold bg-cyan-500 hover:bg-cyan-400 text-black shadow-[0_0_20px_rgba(34,211,238,0.3)] hover:shadow-[0_0_30px_rgba(34,211,238,0.5)] transition-shadow">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="glass-card border-l-0 sm:max-w-xs">
                <nav className="flex flex-col gap-6 text-lg font-medium mt-16">
                  <Link to="/" className="flex items-center gap-3 text-foreground/80 hover:text-foreground transition-colors pb-4 border-b border-white/10">
                  ...
                  <div className="mt-8 flex flex-col gap-4">
                    ...
                    <Button className="w-full h-12 rounded-xl text-base shadow-lg bg-cyan-500 hover:bg-cyan-400 text-black font-bold" asChild>
                      <Link to="/register">Create Account</Link>
                    </Button>
                  </div>
                </nav>
