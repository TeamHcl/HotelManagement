---
name: push-feature
description: Use this skill to automatically sync a feature branch with the repo base branch (main or master) and execute a git push to the remote repository. For frontend changes, ensure lint and build quality checks pass first.
---
# Objective
...
- If the branch includes frontend changes, run `npm run lint` and `npm run build` before pushing.
- For UI-related modifications, keep changes aligned with `.github/references/shadcn-ui-components.md` conventions.
