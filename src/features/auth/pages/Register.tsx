        ...
        <div className="relative z-10 w-full max-w-lg mb-4">
          ...
          >
            ...
            <p className="text-lg text-white/70 font-light max-w-md leading-relaxed tracking-wide">
              Join LuxeStay to reserve exclusive suites or partner with us to list your premium
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <motion.div variants={itemVariants} className="space-y-2 group">
              ...
              <Select value={role} onValueChange={setRole}>
                ...
                <SelectContent className="glass border-white/10 dark">
                  <SelectItem value="CUSTOMER" className="font-medium cursor-pointer py-3">
                    Customer (Book Stays)
                  </SelectItem>
                  <SelectItem value="MANAGER" className="font-medium cursor-pointer py-3">
                    Hotel Manager (List Property)
                  </SelectItem>
                </SelectContent>
              </Select>
            </motion.div>
            ...
            <motion.div
              ...
              className="flex items-start gap-3 mt-4 p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/20 backdrop-blur-sm"
            >
              ...
              <p className="text-[11px] text-muted-foreground/80 leading-relaxed font-medium">
                ...
                <a
                  href="#"
                  className="text-foreground hover:text-cyan-400 transition-colors underline"
                >
                  Terms of Service
                </a>{' '}
                and{' '}
