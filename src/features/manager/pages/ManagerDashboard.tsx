...
const MOCK_HOTELS = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1542314831-c6a4d14d8379?q=80&w=600',
    location: 'Maldives',
    status: 'ACTIVE',
    rooms: 45,
    guests: 112,
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1551882547-ff40c0d129df?q=80&w=600',
    location: 'Tokyo',
    status: 'PENDING',
    rooms: 0,
    guests: 0,
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your hotels, active guests, and inventory centrally.
          </p>
        </div>
        ...
        <TabsContent value="hotels" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {MOCK_HOTELS.map((hotel) => (
              <Card
                key={hotel.id}
                className="glass-card border-white/5 overflow-hidden flex flex-col hover:border-white/20 transition-all"
              >
                <div className="h-48 relative">
                  ...
                  <Badge
                    ...
                    className={`absolute top-4 right-4 backdrop-blur-md ${hotel.status === 'ACTIVE' ? 'bg-emerald-500/80 text-white' : 'bg-background/80 text-amber-500'}`}
                  >
                    {hotel.status}
                  </Badge>
                </div>
        ...
        <TabsContent value="rooms">
          <Card className="glass-card border-white/5">
            <CardHeader>
              ...
              <CardDescription>
                Manage daily pricing and availability for your selected property.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
